...
int ClObj_dt(GAME* _p47, ClObj_c* _p46) {
    return 1;
}

int ClObj_set4(GAME* _p45, ClObj_c* cl, ACTOR* actor, ClObjData_c* data) {
...
void ClObj_OCClear(GAME* _p44, ClObj_c* cl) {
...
void ClObjElem_OCClear(GAME* _p43, ClObjElem_c* elem) {
...
int ClObjPipeAttr_dt(GAME* _p42, ClObjPipeAttr_c* _p41) {
    return 1;
}
