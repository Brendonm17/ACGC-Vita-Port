...
#ifdef TARGET_VITA
static const char* card_dir[2] = { "ux0:data/AnimalCrossing/saves/card_a", "ux0:data/AnimalCrossing/saves/card_b" };
#else
...
static void ensure_dirs(void) {
    ...
    sceIoMkdir("ux0:data/AnimalCrossing/saves", 0777);
    sceIoMkdir("ux0:data/AnimalCrossing/saves/card_a", 0777);
    sceIoMkdir("ux0:data/AnimalCrossing/saves/card_b", 0777);
#elif defined(_WIN32)
    _mkdir("save");
    _mkdir("save/card_a");
    _mkdir("save/card_b");
